                    ...
                    <div className='md:h-[528px] md:w-[376px] gap-[16px] flex text-center flex-col'>
                        ...
                        <div className='md:gap-2 gap-[10px] flex items-center text-center w-full justify-between'>
                            {
                                buttons.map((button, index) => (
                                    <Link href={button.path} key={index} className='min-w-[98px] py-[10px] px-[2px] md:min-w-[120px] max-h-[42px] md:p-[10px] border rounded-lg border-black'>
                                        {button.name}
                                    </Link>
                                ))
                            }
                        ...
                        <form onSubmit={handleSubmit(onSubmit)} className='w-full flex flex-col gap-[14px]'>
                            ...
                            <div className='gap-[32px] flex flex-col'>
                                ...
                                <button className='w-full p-[10px] bg-[#4B91F1] rounded-[10px] text-white'>Let's Start</button>
                            </div>
                        </form>
                            ...
                            <div className='flex lg:gap-[10px] justify-between'>
                                {
                                    socialLogin.map((logos, index) => (
                                        <button key={index} className='lg:w-[106px] lg:h-[42px] border border-[#22B7D8] rounded-[10px] flex justify-center px-2 py-1'>
                                            {logos.icon}
                                        </button>
                                    ))
                                }
